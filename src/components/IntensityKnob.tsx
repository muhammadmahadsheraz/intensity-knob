            ...
            <div className="knob-container">
                <div aria-label="Schedule-intensity">
                    <div className="radio-container radio-steady">
                        <input id="radio-low" className="radio-input" type="radio" name="intensity" value="low" checked={safeValue === "low"} onChange={() => onChange("low")} />
                        <label htmlFor="radio-low" className="label-design">Steady</label>
                    </div>
                    <div className="radio-container radio-mild">
                        <input id="radio-mild" className="radio-input" type="radio" name="intensity" value="mild" checked={safeValue === "mild"} onChange={() => onChange("mild")} />
                        <label htmlFor="radio-mild" className="label-design">Mild</label>
                    </div>
                    <div className="radio-container radio-moderate">
                        <input id="radio-moderate" className="radio-input" type="radio" name="intensity" value="moderate" checked={safeValue === "moderate"} onChange={() => onChange("moderate")} />
                        <label htmlFor="radio-moderate" className="label-design">Moderate</label>
                    </div>
                    <div className="radio-container radio-intense">
                        <input id="radio-intense" className="radio-input" type="radio" name="intensity" value="intense" checked={safeValue === "intense"} onChange={() => onChange("intense")} />
                        <label htmlFor="radio-intense" className="label-design">Intense</label>
                    </div>
                    <div className="radio-container radio-extreme">
                        <input id="radio-extreme" className="radio-input" type="radio" name="intensity" value="extreme" checked={safeValue === "extreme"} onChange={() => onChange("extreme")} />
